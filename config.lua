...
config.keybind =
'F10'                                                                                      -- change it whatever keybind do you like -- look more here https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
config.logo = 'https://files.fivemerr.com/images/97357eb2-130b-4c03-9f68-45d3102bbb4c.png' -- url of logo
